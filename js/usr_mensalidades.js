ativaMenu('menu_mol_usu_mensalidade',false)
...
function preencheFormAlteracao(USUARIO_LOGADO,erro){
    ...
    let textoOption = document.createTextNode(USUARIO_LOGADO['PERFIL']['NOME']+" "+USUARIO_LOGADO['PERFIL']['SOBRE_NOME']);
    option.appendChild(textoOption)
    option.setAttribute('value', USUARIO_LOGADO['ID']);
