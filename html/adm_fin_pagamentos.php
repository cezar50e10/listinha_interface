...
<div id="area_tela_pesquisa">
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <select class="form-select" id="usuarioFiltro">
...
<div id="area_tela_comprovante" class="d-flex justify-content-center visually-hidden col-sm-12 visually-hidden">
  ...
  <form id="formPagto" class="col-lg-8 col-sm-12">
        ...
        <div class="row g-3">
          ...
          <button class="btn btn-lg col-sm-6 btn-primary" id="btnPagamentoPerdoado" type="submit" onclick="processarPagamento(1)">Perdoar</button>
          <button class="btn btn-lg col-sm-6 btn-warning" id="btnPagamentoManual" type="submit" onclick="processarPagamento(2)">Dar Baixa Manual</button>
...
<script src="../../interface/js/adm_fin_pagamentos.js"></script>
